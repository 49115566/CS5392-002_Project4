...
public: // Public members
    ...
    std::unordered_set<std::string> getFilesByOrg(const std::string &word) const; // Get files by organization
    std::unordered_set<std::string> getFilesByName(const std::string &word) const; // Get files by name
    std::unordered_set<std::string> getOtherFilesByWord(const std::string &word) const; // Get other files by word
    std::unordered_set<std::string> getFilesByWord(const std::string &word) const; // Get files by word
    void save(const std::string &filenamepath, const std::string &ofilepath, const std::string &nfilepath, const std::string &wfilepath) const; // Save data to files
    bool load(const std::string &filenamepath, const std::string &ofilepath, const std::string &nfilepath, const std::string &wfilepath); // Load data from files
};
